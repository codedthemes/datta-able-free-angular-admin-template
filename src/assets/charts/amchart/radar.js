  ...
  d.AmRadarChart = d.Class({
    ...
    drawChart: function () {
      ...
      this.gridAboveGraphs ||
        (this.gridSet.toBack(), this.axesSet.toBack(), this.set.toBack());
    },
    ...
    construct: function (a) {
      ...
      if (b) {
        ...
        "middle" == a.pointPosition &&
          "circles" != a.gridType &&
          ((a.rMultiplier = Math.cos(((180 / l) * Math.PI) / 180)),
          (z *= a.rMultiplier));
        for (w = 0; w < l; w += a.axisFrequency) {
          ...
          0 < m &&
            ((t = d.line(b.container, [0, t], [0, q], f, m, c)),
            this.set.push(t),
            d.setCN(b, t, a.bcn + "line"));
          if (e) {
            var x = "start",
    ...
    construct: function (a, b, c, f, m, n, e, r) {
      ...
      if (0 < g) {
        if ("polygons" == H) {
          ...
          for (k = 0; k < u; k++)
            (p = 180 - (360 / u) * k),
              r.push(b * Math.sin((p / 180) * Math.PI)),
              h.push(b * Math.cos((p / 180) * Math.PI));
          r.push(r[0]);
          h.push(h[0]);
      ...
      if (1 == n && 0 < B && !e && "" !== c) {
        ...
        if ("polygons" == H) {
          for (k = u; 0 <= k; k--)
            (p = 180 - (360 / u) * k),
              r.push(e * Math.sin((p / 180) * Math.PI)),
              h.push(e * Math.cos((p / 180) * Math.PI));
  ...
  d.RadarFill = d.Class({
    construct: function (a, b, c, f) {
      ...
      if ("polygons" == a.gridType) {
        ...
        for (l = 0; l < a; l++)
          (h = 180 - (360 / a) * l),
            k.push(c * Math.sin((h / 180) * Math.PI)),
            p.push(c * Math.cos((h / 180) * Math.PI));
        k.push(k[0]);
        p.push(p[0]);
        for (l = a; 0 <= l; l--)
          (h = 180 - (360 / a) * l),
            k.push(m * Math.sin((h / 180) * Math.PI)),
            p.push(m * Math.cos((h / 180) * Math.PI));
