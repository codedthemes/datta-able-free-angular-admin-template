...
(function () {
  ...
  a.formatDuration = function (r, q, p, o, n, m) {
    ...
    "ss" == q &&
      ((r = a.formatNumber(r, m)), 1 == r.split(i)[0].length && (r = "0" + r));
  ...
  a.formatDataContextValue = function (g, f) {
    if (g) {
      ...
      for (h = 0; h < j.length; h++) {
        ...
        void 0 !== f[i] &&
          (g = g.replace(new RegExp("\\[\\[" + i + "\\]\\]", "g"), f[i]));
      }
    }
    return g;
  };
  ...
  a.easeOutElastic = function (i, f, n, l, m) {
    ...
    return (
      j * Math.pow(2, -10 * f) * Math.sin((2 * (f * m - i) * Math.PI) / k) +
      l +
      n
    );
  };
    ...
    draw: function () {
      ...
      if (!isNaN(al)) {
        ...
        if (this.show) {
          ...
          this.className &&
            (ab.className =
              ab.className + " " + V + "-balloon-div-" + this.className);
          V = ab.style;
...
(function () {
  ...
  a.polygon = function (A, z, y, x, w, v, u, s, q, o, j) {
    ...
    u = Math.round;
    o &&
      ((z[d] = a.roundTo(z[d], 5)), (y[d] = a.roundTo(y[d], 5)), (u = Number));
    s = "M" + (u(z[0]) + j) + "," + (u(y[0]) + v);
  ...
  a.line = function (v, u, t, s, r, q, p, o, j, i, d) {
    ...
    s = Math.round;
    i &&
      ((s = Number), (u[0] = a.roundTo(u[0], 5)), (t[0] = a.roundTo(t[0], 5)));
    i = a.dx;
    r = a.dy;
    p = "M" + (s(u[0]) + i) + "," + (s(t[0]) + r);
    ...
    for (var u = [], v = [], s = 1; s < y.length; s++) {
      for (
        var r = Number(y[s - 1]),
          ...
          i =
            Math.round(
              Math.sqrt(Math.pow(o - r, 2) + Math.pow(j - q, 2)) / 50,
            ) + 1,
          o = (o - r) / i,
          j = (j - q) / i,
          f = 0;
  ...
  a.AmLegend = a.Class({
    ...
    createEntry: function (L) {
      if (!1 !== L.visibleInLegend && !L.hideFromLegend) {
        ...
        J.accessible &&
          K.accessibleLabel &&
          ((D = a.massReplace(K.accessibleLabel, { "[[title]]": L.title })),
    ...
    createValue: function (r) {
      ...
      if (!1 !== r.visibleInLegend && !r.hideFromLegend) {
        ...
        p = q.container
          .rect(r.legendEntryWidth, 0, m, o, 0, 0)
            ...
            if (void 0 !== q.type) {
              ...
              o
                ...
                : j &&
                  ...
                  ((j = a.massReplace(j, { "[[title]]": q.title })),
...
(function () {
  ...
  a.AmMap = a.Class({
        ...
        if ((E = D.mapContainer)) {
          ...
          if (!isNaN(v)) {
            ...
            var d = Math.sqrt(Math.pow(v - z, 2) + Math.pow(u - x, 2)),
              i = D.initialDistance;
            isNaN(i) &&
              (i = Math.sqrt(Math.pow(v - z, 2) + Math.pow(u - x, 2)));
            if (!isNaN(i)) {
        ...
        if (void 0 != j) {
          if ("MapImage" == g.objectType) {
            ...
            if ("MapLine" == g.objectType) {
              if (
                ((i = g.lineSvg) && i.setAttr("stroke", j), (i = g.arrowSvg))
              ) {
    ...
    milesToPixels: function (d) {
      ...
      return (
        ((this.mapWidth / (c.rightLongitude - c.leftLongitude)) * d) / 69.172
      );
    },
    kilometersToPixels: function (d) {
      var c = this.dataProvider;
      return (
        ((this.mapWidth / (c.rightLongitude - c.leftLongitude)) * d) / 111.325
      );
    },
    ...
    coordinatesToXY: function (f, d) {
      ...
      this.projectionFunction
        ? ((g = this.projectionFunction(
          ...
          (h =
            this.mapScale * a.roundTo(this.x2c(a.radiansToDegrees(g[0])), 3)),
          (g =
            this.mapScale * a.roundTo(this.y2c(a.radiansToDegrees(g[1])), 3)))
    ...
    coordinateToLongitude: function (f, e) {
      ...
      this.mapSet &&
        (h = (f / e) * (g.rightLongitude - g.leftLongitude) + g.leftLongitude);
...
(function () {
  ...
  a.SimpleButton = a.Class({
    ...
    init: function (C, B, A, z, y, x, w, v, u, s, o, j, D) {
      ...
      d.svgIcon &&
        ((i = d.svgIcon), D ? i.translate(B, B) : i.translate(B / 2, B / 2));
      s.setAttr("cursor", "pointer");
      i &&
        (s.push(i),
        i.setAttr("opacity", o),
...
(function () {
  ...
  a.AreasProcessor = a.Class({
    ...
    process: function (r) {
      ...
      for (o = 0; o < p; o++) {
        if (
          ((n = r[o]), (n.value = Number(n.value)), (n = n.value), !isNaN(n))
        ) {
          if (!1 === j || j < n) {
            j = n;
          }
