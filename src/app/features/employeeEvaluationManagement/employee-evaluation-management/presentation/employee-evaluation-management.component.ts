...
export default class EmployeeEvaluationManagementComponent implements OnInit, OnDestroy {
  ...
  metric1 = [
    ...
    { name: "المقدرة على أداء العمل بدون رقابة أو متابعة", score: 80, randomValue1: 73, randomValue2: 60 },
    { name: "درجة الاعتماد عليه", score: 70, randomValue1: 64, randomValue2: 53 },
    ...
    { name: "نقل آراء الآخرين ومناقشتها", score: 60, randomValue1: 50, randomValue2: 45 },
  ...
  metric2 = [
    ...
    { name: "المحافظة على أسرار العمل والمستندات السرية", score: 35, randomValue1: 35, randomValue2: 40 },
